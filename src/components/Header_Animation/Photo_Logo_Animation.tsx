    ...
    render(){
        return (
            ...
            <div className = 'photo-container' onClick = {this.handleClick} >
                ...
                <img src = '/media/shreyas_icon.jpeg' alt = 'Shreyas Photo' className = 'main-icon-photo' id='shreyas' /> 
                {/* <img src = '/media/logo_coin.png' alt='Website Icon' className = 'main-icon-photo' id='icon' /> */}
            </div>
